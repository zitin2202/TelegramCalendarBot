На данный момент бот не работает. После внесения Google изменений, больше нельзя авторизоваться с помощью копировать и вставки токена авторизации пользователя. 
Внести изменения и сделать проект работоспособным возможно только при наличии подходящего домена исервера, который можно использовать для сохранения токена авторизации пользователя
