...
который можно использовать как связующее звено между авторизацией пользователя и программой бота.
В таком случае, токен авторизации будет передавать этот сервер
